...
$total    = 0;
  ...
  try {
    ...
    //forでもwhileでもforeachでもこの{ }の中が繰り返されるのは全く一緒です。
      ...
      //はい、ではこれで$totalに合計金額が入りましたので、この$totalを表示してあげましょう！
    $total = 0;
    foreach($rows as $row){
