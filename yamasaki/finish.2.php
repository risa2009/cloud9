...
$item_id = '';
//はい、オッケーです＾＾確認して見ましょう！はい、成功しました。カートの中も空になりました。
//はい、バッチリですね＾＾これでログイン処理はほぼ完成です。
//あとはログアウトですが、これは教科書のlogout.phpをそのまま利用できます。
//単にコピペで作成して、そのファイルへのリンクを貼るだけでほぼ終了です。
//あとはリダイレクト先を変えるだけですね！承知しました。ログアウトのちほど作ってみますね！
//はい＾＾あとはfinish画面の表示を仕上げておいてくださいね＾＾まだcartのままですので。そうですね！そのままでした。
//はい＾＾あとは、ここからですが、画像を増やしたり、説明のテキストなどを増やしてユーザーにわかりやすくして行きましょう！
//機能追加やエラーチェックは今のままでいいですので、サンプルとして手を加えた内容だけ
//チェックしておいてください。
//あとは見栄えを整えるだけで、直前で手を入れるのは避けておきましょう。
//直前で動かなくなってしまうと大変です。
//明後日に迫りましたが、自己紹介の準備なども忘れずにしておいてくださいね＾＾
//はい！オンラインからなのですが、よろしくお願いいたします。
//はい＾＾ちなみにオンラインはこっそり自己紹介プレゼンに原稿用意できるのでお得です＾＾
//原稿チェックなどもするのでお申し付けくださいね！はい！明日の夜までに用意します。
//はい＾＾では、長丁場でしたがお疲れ様でした！睡眠もとってくださいね！
//はい、最後の最後まで、本当にありがとうございました。お疲れ様です。m(_ _)m
//はい＾＾お疲れ様でした！失礼します！＾＾
